...
class RequestVerificationCode
{
    ...
    /**
     * RequestVerificationCode constructor.
     *
    ...
    public function __construct(
        ...
        $this->senderAddressType = $this->normalizeEnum($senderAddressType, SenderAddressType::class) ?? SenderAddressType::INTERNATIONAL();
        $this->usageType = $this->normalizeEnum($usageType, UsageType::class) ?? UsageType::OWN_NUMBER();
